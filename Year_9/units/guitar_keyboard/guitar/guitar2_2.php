...
<div class="page-content">
    ...
    <div class="text-content">
        ...
        <div class="hint">
            <h3><img src="/images/hint.svg" alt="" class="icon">Hint</h3> you can't see the form below, try signing into your microsoft account or use
            <a href="#" target="_blank" rel="noopener noreferrer" class="text-link">this link.</a>
        </div>
